...
import com.example.module_order_service.order.infrastructure.client.ProductFeignClient;
...
//    private Long saveReservationProduct() {
//        ReservationProduct reservationProduct = ReservationProduct.builder()
//                .name("예약상품")
//                .content("예약상품내용")
//                .price(20000l)
//                .purchaseButtonActivationAt(LocalDateTime.now().plusDays(1))
//                .build();
...
//                .andExpect(jsonPath("$.data.address").value("서울특별시 xxx동 xxx아파트 xx호"));
    ...
    void 주문_생성_요청() throws Exception {
        ...
        when(reservationProductStockRepository.findById(any(Long.class)))
